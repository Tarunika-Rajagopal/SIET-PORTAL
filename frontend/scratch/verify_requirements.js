...
assert('MyTeams shows all weeks (Week 1 through Week 8)', 
  myTeams.includes('ALL_WEEKS') || myTeams.includes('milestones') || (myTeams.includes('Week 1') && myTeams.includes('Week 8'))
);
